...
> ZhiYiQuant supports strategy signal notifications via email, ideal for users who need detailed notification records.
...
- ZhiYiQuant backend service deployed and running

---

## Supported Email Providers

ZhiYiQuant supports any standard SMTP protocol email provider, including:
...
Yes, ZhiYiQuant automatically sends formatted HTML emails with a plain text fallback for maximum compatibility.

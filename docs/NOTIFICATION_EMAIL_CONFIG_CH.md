...
> ZhiYiQuant 支持通过邮件推送策略信号通知，适合需要详细通知记录的用户。
...
- ZhiYiQuant 后端服务已部署并运行

---

## 支持的邮件服务商

ZhiYiQuant 支持任何标准 SMTP 协议的邮件服务商，包括但不限于：
...
是的，ZhiYiQuant 自动发送包含格式化信息的 HTML 邮件，同时附带纯文本备选内容以确保兼容性。

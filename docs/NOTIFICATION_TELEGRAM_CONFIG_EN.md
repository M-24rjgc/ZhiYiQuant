...
> ZhiYiQuant supports real-time strategy signal notifications via Telegram Bot.
...
3. Enter a display name for your bot (e.g., `ZhiYiQuant Signal Bot`)
4. Choose a unique username ending with `bot` (e.g., `zhiyiquant_signal_bot`)

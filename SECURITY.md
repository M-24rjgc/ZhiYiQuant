...
ZhiYiQuant is a **local-first, self-hosted quantitative trading system**.
...
ZhiYiQuant is under active development.
...
or commit when running ZhiYiQuant in production environments.

---

## 🧠 Security Model & Scope

ZhiYiQuant is designed to run **entirely under the user’s control**.

### In Scope
We consider the following areas in scope for security review:

- Source code vulnerabilities in this repository
- Authentication and authorization logic within ZhiYiQuant
...
If you believe you have found a security vulnerability in ZhiYiQuant,
...
ZhiYiQuant is provided **as-is**, without warranty.
...
Thank you for helping keep ZhiYiQuant safe.

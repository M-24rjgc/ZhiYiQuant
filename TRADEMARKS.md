# ZhiYiQuant Trademarks & Branding Policy

This document governs the use of **ZhiYiQuant** trademarks and brand assets (including the name, logo, and visual identity).  
...
The following are considered **ZhiYiQuant brand assets**:

- The **ZhiYiQuant** name and word marks
- The ZhiYiQuant **logo**, icon, and related images
...
- Use ZhiYiQuant trademarks/branding in a way that **suggests endorsement**, sponsorship, affiliation, or official status when it is not true.
- Redistribute a **modified** version of the software while keeping ZhiYiQuant branding in a way that could confuse users about the origin.
- **Modify, adapt, recolor, distort, crop, or create derivative works** of the ZhiYiQuant logo or other brand assets.
- **Replace/alter/remove** ZhiYiQuant branding in a redistribution **while still using the ZhiYiQuant name/logo/brand** (including in-app UI branding), unless you have a commercial license.
- Use ZhiYiQuant branding to market a competing product/service as “official”, “certified”, or “approved” by ZhiYiQuant.
...
- **Do not** use “ZhiYiQuant” as the primary product name.
- **Do not modify** ZhiYiQuant logos/brand assets. If you do not have a commercial license, you should **remove ZhiYiQuant branding and rebrand** your distribution to avoid confusion.
- Keep required Apache 2.0 notices (LICENSE/NOTICE) and do not misrepresent authorship.

If you distribute an **unmodified** build, you may keep ZhiYiQuant branding, but you must not imply that your organization is the official owner unless authorized.
...
- Keeping ZhiYiQuant branding in a redistributed modified version
- **Changing/replacing/removing** ZhiYiQuant branding in the UI/distribution (as agreed)
...
- Email: `mailto:M-24rjgc@gmail.com`

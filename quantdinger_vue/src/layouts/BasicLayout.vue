...
export default {
  ...
  data () {
    return {
      ...
      menuFooterConfig: {
        contact: {
          support_url: 'https://t.me/zhiyiquant',
          feature_request_url: 'https://github.com/M-24rjgc/ZhiYiQuant/issues',
          email: 'M-24rjgc@gmail.com',
          live_chat_url: 'https://t.me/zhiyiquant'
        },
        social_accounts: [
          { name: 'GitHub', icon: 'github', url: 'https://github.com/M-24rjgc/ZhiYiQuant' },
          { name: 'X', icon: 'x', url: 'https://x.com/HenryCryption' },
          { name: 'Discord', icon: 'discord', url: 'https://discord.gg/cn6HVE2KC' },
          { name: 'Telegram', icon: 'telegram', url: 'https://t.me/zhiyiquant' },
          { name: 'YouTube', icon: 'youtube', url: 'https://youtube.com/@zhiyiquant' }
        ],
        legal: {
          user_agreement: '',
          privacy_policy: ''
        },
        copyright: '© 2025-2026 ZhiYiQuant. All rights reserved.'
      },

# ZhiYiQuant Python API (backend)

Flask-based backend for ZhiYiQuant: market data, indicators, AI analysis, backtesting, and a strategy runtime with multi-user support.
...
# Initialize schema
psql -U zhiyiquant -d zhiyiquant -f migrations/init.sql
```

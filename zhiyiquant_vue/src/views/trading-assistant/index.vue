...
export default {
  ...
  methods: {
    ...
    async loadStrategyDataToForm (strategy) {
      ...
      // Market / execution / notification defaults
      ...
      if (strategy.trading_config) {
        ...
        // Support nested configs from the indicator-analysis backtest modal
        ...
        // Normalize the symbol to the "Market:SYMBOL" format used by the watchlist dropdown
    ...
    getPlaceholder (fieldType) {
      const placeholders = {
        ...
        coinbaseexchange: {
          ...
          passphrase: '请输入Passphrase（创建 Coinbase Exchange API 时设置）'
        },
        kucoin: {
          api_key: '请输入API Key',
          secret_key: '请输入Secret Key',
        ...
        bitget: {
          api_key: '请输入API Key',
          secret_key: '请输入Secret Key',
          passphrase: '请输入Passphrase（创建 Bitget API 时设置）'
        }
      }
